...
export const getFeaturedProducts = async (req, res) => {
  try {
    ...
    //   if featuredProducts not in redis, fetch from mongodb
...
// getRecommendedProduct controller
...
async function updateFeaturedProductsCache() {
   try {
      ...
      await redis.set("featrued_products", JSON.stringify(featuredProducts));
   } catch (error) {
...
export const createProduct = async (req, res) => {
  try {
    ...
    //  logic to upload image to cloudinary
